...
public class IndexBuild {
	...
	final static Version LUCENE_VERSION = Version.LUCENE_45;
...
//		final IndexWriter routeLuceneWriter = openWriter(routesDirectory);
		...
		Document docCh1 = createChild("1","1","firstArticle1");
		Document docCh2 = createChild("2","2","SecondAticle1");
		...
		document.add(createChild("3","5","firstArticle12")); 
		document.add(createChild("4","5","SecondAticle12")); 
		document.add(createArticle("3","singlebytednorms1", "REC3tthis"));
		airportLuceneWriter.addDocuments(document);
		document.clear(); 
		
		document.add(createChild("5","6","firstArticle11234")); 
		document.add(createChild("6","6","SecondAticle112345")); 
		document.add(createArticle("4","singlebytednorms12", "REC4tthis"));
		airportLuceneWriter.addDocuments(document);
		
		document.clear();
		document.add(createChild("8","8","comment on first article")); 
		document.add(createChild("9","9","comment on second article")); 
		airportLuceneWriter.addDocuments(document);
	...
	public static void buildBlockQuery123() throws IOException
	{
...
//		final IndexWriter routeLuceneWriter = openWriter(routesDirectory);
	...
	private static Document createChild(String id,String articleId,String content) {
		...
		docChild.add(new Field("childContent",content , Field.Store.YES, Field.Index.NOT_ANALYZED));
		return docChild;
	}
...
/*		final IndexReader airportIndexReader=IndexReader.open(airportDirectory) ;
	...
	//	final IndexWriter airportLuceneWriter = openWriter(airportDirectory);
		...
		document.add(new Field("content","firstArticle" , Field.Store.YES, Field.Index.NOT_ANALYZED));
		...
		document.add(new Field("articleid","2" , Field.Store.YES, Field.Index.ANALYZED));
		document.add(new Field("content","SecondArticle", Field.Store.YES, Field.Index.NOT_ANALYZED));
		routeLuceneWriter.addDocument(document);
